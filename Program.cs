...
namespace Nordvpn
{
  internal class Program
  {
    ...
    private static void Main(string[] args)
    {
      ...
      Colorful.Console.Title = "[NordVPN Checker]| Start Menu | By SheEnjoysHerMilkAlotX#5530|";
      ...
      Colorful.Console.Write("                                  ██      ██   ██  ██████   █████  ███████  ██████    ██        \n", Color.Aqua);
      Colorful.Console.Write("                                                                                                           \n", Color.Aqua);
      Colorful.Console.Write("                              Enjoy the your checking! | Made By SheEnjoysHerMilkAlotX#5530                                  \n", Color.Aqua);
      Colorful.Console.Write("                                                                                                           \n", Color.Aqua);
      Colorful.Console.Write("                                                                                                           \n", Color.Aqua);
      Colorful.Console.Write("                                                                                                           \n", Color.Aqua);
      Colorful.Console.Write("FreeStuffBitches \n", Color.Aqua);
      Colorful.Console.WriteLine();
      Thread.Sleep(250);
      Colorful.Console.Write(DateTime.Now.ToString("[hh:mm:ss]"), Color.Aquamarine);
      ...
      Task.Factory.StartNew((Action) (() =>
      {
        while (true)
        {
          ...
          Program.CPM_aux = 0;
          Colorful.Console.Title = string.Format("[NordVPN Checker] | Checked: {0}/{1} | Hits: {2} | Bad: {3} | Expired: {4} | Errors: {5} | CPM:  |", (object) Program.checkedCounter, (object) Program.totalCounter, (object) Program.hitCounter, (object) Program.badCounter, (object) Program.Expired, (object) Program.errorCounter) + (Program.CPM * 60).ToString();
          Thread.Sleep(1000);
        }
      }));
      Task.Factory.StartNew((Action) (() =>
